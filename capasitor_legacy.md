# Capacitor-Era Development Log (Legacy)

This file archives all entries from the Capacitor + WebView build of IsaiVazhi.
The active app is now the Kotlin + Jetpack Compose rewrite at `native/` — see `project_development.md` for current work.

Migration cutoff: 2026-05-11 push #22 (Kotlin port started). Everything before that lives here.
