...
# !! EDIT THIS !! - Path to your songs folder on the laptop
SONGS_DIR = r'C:\path\to\your\songs'

# Path where these same songs exist on your phone (from MediaStore scan)
PHONE_MUSIC_BASE = '/storage/emulated/0/songs_downloaded'

# Output and checkpoint are placed next to this script automatically
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_DIR  = SCRIPT_DIR
CKPT_PATH   = os.path.join(SCRIPT_DIR, 'music_audioset_epoch_15_esc_90.14.pt')

# =============================================================================
# Constants (matching mobile EmbeddingService.java exactly)
# =============================================================================
...
# =============================================================================
# Helper Functions (matching mobile app logic)
# =============================================================================
...
def build_phone_path(filepath):
    """
    Convert a local file path into the matching phone-side path.
